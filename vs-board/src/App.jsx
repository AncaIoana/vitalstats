...
const INITIAL_STORIES = [
  ...
  { id: "s64", phase: "phase1", epic: "Ingestion", title: "Write extract_vaccines.py for Vaccines tab", status: "backlog", priority: "high", notes: "Read Vaccines tab. Filter WHERE Name = TRACKED_PERSON_NAME (env var) — discard partner rows. Strip trailing spaces from vaccine names. Parse booster_due float year. See medications-vaccines-schema.md." },
  { id: "s65", phase: "phase1", epic: "Database", title: "Create stg_medications + stg_vaccines tables", status: "backlog", priority: "high", notes: "Silver staging tables. stg_medications: one row per medication period. stg_vaccines: one row per vaccine admin (tracked person only). See database-schema.md." },
  ...
  { id: "s67", phase: "phase1", epic: "dbt", title: "Write stg_vaccines.sql", status: "backlog", priority: "high", notes: "Clean vaccine names, parse booster_due, derive booster_due_date. Filter to tracked person confirmed at this layer too." },
