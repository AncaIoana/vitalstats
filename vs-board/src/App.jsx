...
const INITIAL_STORIES = [
  ...
  { id: "s64", phase: "phase1", epic: "Ingestion", title: "Write extract_vaccines.py for Vaccines tab", status: "backlog", priority: "high", notes: "Read Vaccines tab. Filter WHERE Name = 'Anca' — discard Lukasz rows. Strip trailing spaces from vaccine names. Parse booster_due float year. See medications-vaccines-schema.md." },
  { id: "s65", phase: "phase1", epic: "Database", title: "Create stg_medications + stg_vaccines tables", status: "backlog", priority: "high", notes: "Silver staging tables. stg_medications: one row per medication period. stg_vaccines: one row per vaccine admin (Anca only). See database-schema.md." },
  ...
  { id: "s67", phase: "phase1", epic: "dbt", title: "Write stg_vaccines.sql", status: "backlog", priority: "high", notes: "Clean vaccine names, parse booster_due, derive booster_due_date. Filter to Anca confirmed at this layer too." },
  ...
  { id: "s69", phase: "phase1", epic: "dbt", title: "Add medication active flags to mart_ml_features", status: "backlog", priority: "medium", notes: "med_metyrapone_active, med_ferrous_sulfate_active, med_simvastatin_active etc. Binary features for each tracked medication — critical for blood test interpretation." },
  ...
  { id: "s70", phase: "phase3", epic: "ML", title: "Cross-source ML: blood tests + medications", status: "backlog", priority: "medium", notes: "Ferritin vs ferrous sulfate dose. ALT vs Metyrapone active periods. Cholesterol vs Simvastatin. Medication active flag as feature in all blood test models." },
